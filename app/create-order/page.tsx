...
const eopyySteps: OrderStep[] = [
    ...
    items: [
      {
        ...
        title: "Βήμα 5: Για κάθε υλικό εμφανίζονται",
        blocks: [
          {
    ...
    items: [
      {
        ...
        title: "Βήμα 6: Συμμετοχή",
        blocks: [
          {
            title: "Επιβεβαίωση Είσπραξης συνολικού ποσού",
            items: ["👉 Ελέγξτε το ποσό συμμετοχής", "Ενεργοποιήστε την επιλογή «Επιβεβαίωση συνολικού ποσού»", "Ή συμπληρώστε το ποσό που εισπράχθηκε"],

            note: "⚠️ Αν το ποσό έκπτωσης είναι μεγαλύτερο από 25% της συμμετοχής, απαιτείται έγκριση.",
          },
          {
            title: "ΕΦΑΡΜΟΓΗ ΕΚΠΤΩΣΗΣ",
            items: [
              "👉 Αν απαιτείται έκπτωση, ενεργοποιήστε την επιλογή «Εφαρμογή έκπτωσης", "Στη συνέχεια επιλέξτε τον λόγο έκπτωσης από τη λίστα.",
            ],
            note: "Βεβαιωθείτε ότι τα υλικά συμφωνούν με τη γνωμάτευση πριν προχωρήσετε στο επόμενο βήμα.",
          },
        ],
        media: [
          { type: "image", src: "/order/step6.png", alt: "Συμμετοχή" },
          { type: "image", src: "/order/step6-1.png", alt: "Εφαρμογή Έκπτωσης" },
          { type: "image", src: "/order/step6-2.png", alt: "Λόγως Έκπτωσης" },
        ],
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "synainesi-entypo",
        title: "Βήμα 7: Συναίνεση",
        blocks: [
          {
            items: ["Για νέους πελάτες: ανεβάστε Έντυπο Συναίνεσης"],
            note: "👉 Το αρχείο έχει ανέβει επιτυχώς (Uploaded) και είναι έτοιμο για χρήση. ✔ Μπορείτε να προχωρήσετε στο επόμενο βήμα.",
          },

        ],
        media: [
          { type: "image", src: "/order/step7.png", alt: "Έντυπο Συναίνεσης" },
          { type: "image", src: "/order/step7-1.png", alt: "Uploaded Έντυπο Συναίνεσης" },
        ],
      },
    ],
  },
  {
    ...
    step: "Βήμα 8",
    title: "Touchdown",
    description: "Σε αυτό το βήμα μπορείτε να επιλέξετε τον τρόπο αποθήκευσης της παραγγελίας και να καταχωρήσετε τυχόν σχόλια.",
    items: [
      {
        id: "touchdown-sxolia",
        title: "Βήμα 8: Touchdown",
        blocks: [
          {
        ...
        media: [
          { type: "image", src: "/order/step8.png", alt: "Touchdown" },
          { type: "image", src: "/order/step8-1.png", alt: "Ελλείψεις" },
          { type: "image", src: "/order/step8-2.png", alt: "Επιβεβαίωση Υποβολής" },
        ],
      },
    ],
  },
